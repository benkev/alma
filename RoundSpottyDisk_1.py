...
ia.fromshape("RoundSpottyDisk1.im",[2048,2048,1,1],overwrite=True)

cs=ia.coordsys()
cs.setunits(['rad','rad','','Hz'])
cell_rad=qa.convert(qa.quantity("0.00016arcsec"),"rad")['value']
...
exportfits(imagename='RoundSpottyDisk1.im',fitsimage='RoundSpottyDisk1.fits',
           overwrite=True)
